...
(1, 'Tech Solutions Co., Ltd.', 'Senior Software Developer', 'Mr. Somchai Tech', '456 Silom Road', 'Phnom Penh', 'Phnom Penh', '10500', '2025-06-17 01:48:24');
...
(1, 1, 'Master of Information System', 'Computer Science', 'SETEC INSTITUTE', '2019-10-21', '2023-09-20', 0, '3.85', 'Published 2 research papers\r\nReceived full scholarship\r\nGraduated with honors'),
(2, 1, 'Bachelor of Management Information System', 'Computer Engineering', 'SETEC INSTITUTE', '2024-06-01', '2025-06-26', 0, '3.75', 'Dean\'s List all semesters\r\nLed student programming club\r\nWon 3 programming competitions');
...
(9, 'Tieng Chamrern', 'Senior Web Developers', 'tiengchamrern2@gmail.com', '+855 78783645 / 967797762', '165 cm', '52 kg', '2003-11-10', 'Male', 'Khmer', 'Single', 'Cambodian', 'Sangkat TuekThla, Khan Sensokh,', 'Phnom Penh', 'Phnom Penh', '120802', 'Cambodia', 'Phnom Penh, Cambodia', '2025-06-26 09:10:10'),
(10, 'Tieng Chamrern', 'Web Developer', 'tiengchamrern2@gmail.com', '+855 78783645 / 967797762', '165 cm', '52 kg', '2003-11-10', 'Male', 'Khmer', 'Single', 'Cambodian', 'Sangkat TuekThla, Khan Sensokh,', 'Phnom Penh', 'Phnom Penh', '120802', 'Cambodia', 'Phnom Penh, Cambodia', '2025-06-26 09:11:19');
...
CREATE TABLE IF NOT EXISTS `seo_analytics` (
  ...
  `referring_domains` text COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `seo_analytics` (`id`, `page_url`, `page_views`, `unique_visitors`, `bounce_rate`, `avg_time_on_page`, `search_keywords`, `referring_domains`, `social_shares`, `date`, `created_at`, `updated_at`) VALUES
(1, '/certificates.php', 120, 90, '42.50', 180, 'AWS certification, cloud skills, resume', 'google.com, linkedin.com', 15, '2025-06-20', '2025-06-24 12:14:39', '2025-06-24 12:14:39');
...
CREATE TABLE IF NOT EXISTS `seo_metadata` (
  ...
  `meta_author` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `og_site_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT 'Portfolio System',
  `og_locale` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT 'en_US',
  ...
  `twitter_site` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT '@portfoliosystem',
  ...
  `theme_color` varchar(7) COLLATE utf8mb4_unicode_ci DEFAULT '#007bff',
...
(1, 'site_name', 'Portfolio System', 'Website name for SEO and social media', 1, '2025-06-20 06:00:00', '2025-06-20 06:00:00'),
(2, 'site_description', 'Professional CV and Portfolio Management System', 'Default site description for SEO', 1, '2025-06-20 06:00:00', '2025-06-20 06:00:00'),
(3, 'site_keywords', 'CV, portfolio, resume, professional, career, skills, experience', 'Default site keywords for SEO', 1, '2025-06-20 06:00:00', '2025-06-20 06:00:00'),
(4, 'google_analytics_id', '', 'Google Analytics tracking ID', 1, '2025-06-20 06:00:00', '2025-06-20 06:00:00'),
(5, 'google_search_console', '', 'Google Search Console verification code', 1, '2025-06-20 06:00:00', '2025-06-20 06:00:00'),
(6, 'bing_webmaster_tools', '', 'Bing Webmaster Tools verification code', 1, '2025-06-20 06:00:00', '2025-06-20 06:00:00'),
(7, 'default_og_image', '/images/default-og.jpg', 'Default Open Graph image for social sharing', 1, '2025-06-20 06:00:00', '2025-06-20 06:00:00');
...
(7, 'Mao', '$2y$10$v3XRjlSaC1On404H8pDcPuhdwIArP4VDOFxlhwiT/uVlIZqaOdkbC', 'mao@gmail.com', '2025-06-24 07:14:57');
COMMIT;
